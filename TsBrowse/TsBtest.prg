/* Based on Minigui Extended version 1.5.b54 */
   ...
   aFont[ 5 ] := GetFontHandle( "Font_5"  )
    ...
    IF !IsWIndowDefined (&cWnd )
        ...
        DEFINE WINDOW &cWnd ;
            ...
            WIDTH nBrwWidth+8 HEIGHT nWinHeight ;
            TITLE cTitle;
            ICON "Demo.ico";
            CHILD;
...
//                    Brw_8:SetOrder( 1, "StName", "NY" )
                ...
                // activating incremental search in columns 3
                    Brw_8:aColumns[ 3 ]:cOrder := "StName"
...
function fBtnGet( nValue, oBrw )
   ...
   DEFINE DIALOG Dlg_2 OF Sample_4  AT 20, 20 WIDTH 300 HEIGHT 200 FONT "Font_8" ;
      ...
      @ 70, 100 TEXTBOX tbox_3 VALUE nLastVal HEIGHT 24 WIDTH 100   ID 112
