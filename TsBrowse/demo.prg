...
Local n
   ...
   next
    ...
    DEFINE WINDOW Form_1 ;
        ...
        TITLE 'MiniGUI TsBrowse Demo - Adaptation TsBrowse 7.0' ;
        ICON "Demo.ico" ;
        MAIN NOMAXIMIZE ;
        ON INIT OpenTables() ;
...
Procedure Brw_5()
   IF !_IsControlDefined ("oBrw5","Form_1")
      Select("TEST")
      @ 10,630 TBROWSE oBrw5  ALIAS "Test";
         OF Form_1 WIDTH 250 HEIGHT 380  CELLED;
      ...
      oBrw5:acolumns[1]:lEdit:=.T.
      oBrw5:acolumns[4]:lEdit:=.T.
      oBrw5:acolumns[5]:lEdit:=.T.
      oBrw5:lNoResetPos := .F.
      oBrw5:lPickerMode := .F.
